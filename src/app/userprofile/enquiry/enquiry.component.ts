...
export class EnquiryComponent implements OnInit {
  ...
  userid: any
  getEnquiryForm: any
  constructor(private nls: NearlukService, private router: Router, private acr: ActivatedRoute, private toastr: ToastrService, private title: Title, private meta: Meta) {

    this.title.setTitle('Enquiry |Nearluk | flat for rent | Flats |Banquet Halls |Godowns |Hospitals |Hostels |Restaurants |Rental Property ');
    this.meta.addTags([
      { name: 'description', content: 'If you have any queries or any suggestion for the NearLuk. We are to discuss with you.' },
