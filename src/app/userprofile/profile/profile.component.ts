...
export class ProfileComponent implements OnInit {
  ...
  constructor(private ns: NearlukService, private router: Router, private toastr: ToastrService, private title: Title, private meta: Meta) {
    this.title.setTitle('Profile - commercial space for rent | Residential property | properties in India | rental websites | property sites in India');
    this.meta.addTags([
      { name: 'description', content: 'The user should provide all the details mentioned and can save the favourite properties. ' },
      { name: 'keywords', content: 'Nearluk,  lease property in Hyderabad, rent property in India, search property for rent, rent flats, villas near me' }
    ]);
