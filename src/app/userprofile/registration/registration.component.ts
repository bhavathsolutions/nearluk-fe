...
export class RegistrationComponent implements OnInit {
  ...
  constructor(private nearlukservice: NearlukService, private router: Router, private toastr: ToastrService, private title: Title, private meta: Meta) {
    this.title.setTitle('Registration | Nearluk | flat for rent | Flats |Banquet Halls |Godowns |Hospitals |Hostels |Restaurants |Rental Property');
    this.meta.addTags([{ name: 'description', content: 'A user have to provide the necessary information and must register to view the properties in NearLuk.' }, { name: 'keywords', content: 'commercial property for rent, Nearluk, commercial space for rent, retail space for rent, commercial lease ' }]);
