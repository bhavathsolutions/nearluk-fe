...
export class RecommendationComponent implements OnInit {
  ...
  items: any[] = [];
  noDataImage: boolean;
  constructor(private nls: NearlukService, private router: Router, private title: Title, private meta: Meta) {
    this.title.setTitle('Recommendations | Nearluk | House for rent | Flat for rent | villa near me | independent house ');
    this.meta.addTags([
      { name: 'description', content: 'Any of the person can freely contact of for any further suggestions regarding the Nearluk.' },
      { name: 'keywords', content: 'houses for rent, NearluK, houses for rent near me, vacation rentals, cheap apartments for rent, duplex for rent' }
    ]);
