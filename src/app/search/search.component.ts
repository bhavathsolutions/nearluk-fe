...
export class SearchComponent implements OnInit {
  ...
  constructor(private nearlukservice: NearlukService,private router: Router, private title: Title, private meta: Meta,private spinner: NgxSpinnerService) {
    this.title.setTitle('Search - commercial property for rent | Nearluk | commercial space for rent | retail space for rent | commercial lease ');
    this.meta.addTags([
      { name: 'description', content: 'Search for the properties with the property type and the location.' },
