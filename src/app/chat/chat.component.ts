...
export class ChatComponent implements OnInit {
  ...
  constructor(private _chatService: NearlukService, public router: Router, private acr: ActivatedRoute, private app: AppComponent, private title: Title, private meta: Meta) {

    this.title.setTitle('Chat | commercial property for rent | commercial space for rent | retail space for rent | commercial lease ');
    this.meta.addTags([
      { name: 'description', content: 'Nearluk provides internal communication between the Owner and the tenant.' },
