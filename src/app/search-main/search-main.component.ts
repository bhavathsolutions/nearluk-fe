...
export class SearchMainComponent implements OnInit {
  ...
  constructor(private nearlukservice: NearlukService, private router: Router, private toastr: ToastrService, private title: Title, private meta: Meta) {
    this.title.setTitle('Advanced Search| flat for rent near me |  Nearluk | rented apartment | Villas | flat for rent | 1 bhk flat for rent | Hostels | Paying Guest | men s hostel near me');
    this.meta.addTags([
      { name: 'description', content: 'The tenant can search for the property with the advanced search category to get the featured properties with Nearluk verified tag and exact location. ' },
      { name: 'keywords', content: 'NearLuk, commercial space for rent, Residential property, properties in India, property websites India, rent websites India' }
    ]);
