...
export class CompareComponent implements OnInit {
  ...
  constructor(private router: Router, private act: ActivatedRoute, private actt: ActivatedRoute, private nearlukservice: NearlukService, private acttt: ActivatedRoute, private title: Title, private meta: Meta) { 

    this.title.setTitle('Compare | flat for rent near me |  Nearluk | rented apartment | Villas | flat for rent | 1 bhk flat for rent | Hostels | Paying Guest | men s hostel near me');
    this.meta.addTags([
      { name: 'description', content: 'The tenant can compare any of the same featured properties and can select their favorite property.' },
      { name: 'keywords', content: 'Nearluk, flat for rent, Flats, Banquet Halls, Godowns, Hospitals, Hostels, Restaurants, Rental Property' }
    ]);
  }
